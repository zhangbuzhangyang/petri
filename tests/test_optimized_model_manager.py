...
try:
    response = model_manager.generate(
        messages=messages,
        model_name=os.getenv("SILICON_FLOW_MODEL_NAME", "Pro/zai-org/GLM-4.7"),
        api_key=os.getenv("SILICON_FLOW_API_KEY", "sk-lfrqavvkjdkwqutatxakzfyuwwfctmwyupzeeeldanegcclo"),
